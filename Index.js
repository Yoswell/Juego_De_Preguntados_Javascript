...
function ciencia() {
    ...
    document.getElementById('contPuntos').style.backgroundColor = '#119e80';
    document.getElementById('conButton').style.backgroundColor = '#119e80';
    document.getElementById('titulin').style.backgroundColor = '#119e80';
    document.querySelector('.header').style.backgroundColor = '#119e80';
...
function estudios() {
    ...
    document.getElementById('contPuntos').style.backgroundColor = '#1f70b3';
    document.getElementById('conButton').style.backgroundColor = '#1f70b3';
    document.getElementById('titulin').style.backgroundColor = '#1f70b3';
    document.querySelector('.header').style.backgroundColor = '#1f70b3';
    const preguntasCulturaGeneral = [
...
function deportes() {
    ...
    document.getElementById('contPuntos').style.backgroundColor = '#a38021';
    document.getElementById('conButton').style.backgroundColor = '#a38021';
    document.getElementById('titulin').style.backgroundColor = '#a38021';
    document.querySelector('.header').style.backgroundColor = '#a38021';
    const preguntasCulturaGeneral = [
...
function cultura() {
    ...
    document.getElementById('contPuntos').style.backgroundColor = '#ac4c33';
    document.getElementById('conButton').style.backgroundColor = '#ac4c33';
    document.getElementById('titulin').style.backgroundColor = '#ac4c33';
    document.querySelector('.header').style.backgroundColor = '#ac4c33';
    const preguntasCulturaGeneral = [
...
function remover() {
    ...
    op1.style.backgroundColor = '#1c1c1c';
    op2.style.backgroundColor = '#1c1c1c';
    op2.style.color = '#fff';
    op3.style.backgroundColor = '#1c1c1c';
}
